...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Pengelolaan Surat Peringatan</title>
    ...
    <body>
        ...
        <div class="sidebar-container" id="sidebar">
            <div class="sidebar">
                ...
                <div class="main">
                    <div class="list-item">
                        <a href="#" data-target="dashboard" data-tooltip="Dashboard" class="active">
                            <i class="fas fa-home"></i>
                            <span class="description">Dashboard</span>
                        </a>
                    </div>
                    <div class="list-item">
                        <a href="#" data-target="mahasiswa" data-tooltip="Data Mahasiswa">
                    ...
                    <div class="list-item">
                        <a href="#" data-target="password" data-tooltip="Manajemen Password">
        ...
        <main class="content" id="content">
            <section id="dashboard" class="content-section active">
                ...
                <div class="card-grid">
                    <div class="card-container">
                        ...
                        <span id="mahasiswaChange">+0 bulan ini</span>
                    </div>
                    <div class="card-container">
                        ...
                        <i class="fas fa-arrow-up"></i>
                        <span id="suratPeringatanChange">+0 bulan ini</span>
                    </div>
                    <div class="card-container">
            ...
            <section id="surat" class="content-section">
                <div class="content-data-mahasiswa">
                    <div class="mahasiswa-header">
                        <div>
        ...
        <script src="assets/dashboard-display-card.js"></script>
        <script src="assets/password-manager.js"></script>
        <script src="assets/data-mahasiswa.js"></script>
        <script src="assets/suratperingatan.js"></script>
    </body>
</html>